...
- `src/lib/analysis-presentation.ts` แปลงหมวดความล้มเหลวเป็นกฎการนำเสนอว่าหน้าจอควรใช้มาสคอตออฟไลน์หรือไม่ เพื่อไม่ให้โมดูลจำแนก error ผูกกับรายละเอียดของหน้าจอ
